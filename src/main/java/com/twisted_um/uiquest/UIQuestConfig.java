...
public class UIQuestConfig {
    ...
    public static final ModConfigSpec.BooleanValue SHOW_CHAIN_IN_LIST;
    public static final ModConfigSpec.BooleanValue SHOW_CHAIN_IN_HUD;

    public static final ModConfigSpec.BooleanValue SHOW_EMPTY_CHAPTERS;
